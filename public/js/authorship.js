$(document).ready(function () {
    $("#addButton").click(function () {
        ...
        $('.form-horizontal').append('<br class="removeMe"><div class="input-group-prepend">' +
            '<span class="input-group-text" style="width: 180px">Name</span>' +
            '<input class="form-control" type="text" name="authorName" placeholder="Name ' + id + '" style="margin: 0 20px 0 0">' +
            '<span class="input-group-text" style="width: 180px">Email</span>' +
            '<input class="form-control" type="text" name="authorEmail" placeholder="Email ' + id + '" style="margin: 0 20px 0 0">' +
            '</div>');
    });
